...
export const Newsletter: React.FC<NewsletterProps> = ({ onSubmit }) => {
  ...
  return (
    <section className="w-full py-12 sm:py-16 md:py-20 lg:py-24 px-4 sm:px-6 lg:px-8 bg-primary-100" aria-label="Newsletter subscription">
      <div className="max-w-2xl mx-auto text-center">
        ...
        <form onSubmit={handleSubmit(onFormSubmit)} className="w-full max-w-md mx-auto" aria-label="Newsletter subscription form">
          <div className="flex flex-col sm:flex-row gap-3">
            <div className="flex-1">
              ...
              />
              {errors.email && (
                <p id="email-error" className="text-error text-sm sm:text-base mt-2 text-left" role="alert">{errors.email.message}</p>
              )}
            </div>
          ...
          {submitStatus === 'success' && (
            <div className="mt-4 p-4 bg-success-light border border-success rounded-lg" role="status" aria-live="polite">
          ...
          {submitStatus === 'error' && (
            <div className="mt-4 p-4 bg-error-light border border-error rounded-lg" role="alert" aria-live="assertive">
